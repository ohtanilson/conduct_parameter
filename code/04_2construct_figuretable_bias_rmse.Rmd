...
constraint_list <-
  c(
    ...
    #"_optim_nelder_mead_non_constraint_theta_constraint"
    )
...
constraint_list <-
  c(#"_mpec_non_constraint_non_constraint",
    #"_mpec_separate_non_constraint_theta_constraint",
...
#### mpec non_constraint_theta_constraint
...
loglinear_loglinear_sigma_0.001_separate_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_0.001_separate_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_0.001_separate_non_constraint_theta_constraint
)
loglinear_loglinear_sigma_0.5_separate_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_0.5_separate_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_0.5_separate_non_constraint_theta_constraint
)
...
loglinear_loglinear_sigma_1_separate_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_1_separate_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_1_separate_non_constraint_theta_constraint
)
...
loglinear_loglinear_sigma_2_separate_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_2_separate_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_2_separate_non_constraint_theta_constraint
)
...
loglinear_loglinear_sigma_0.001_simultaneous_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_0.001_simultaneous_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_0.001_simultaneous_non_constraint_theta_constraint
)
loglinear_loglinear_sigma_0.5_simultaneous_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_0.5_simultaneous_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_0.5_simultaneous_non_constraint_theta_constraint
)
...
loglinear_loglinear_sigma_1_simultaneous_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_1_simultaneous_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_1_simultaneous_non_constraint_theta_constraint
)
...
loglinear_loglinear_sigma_2_simultaneous_non_constraint_theta_constraint <-
  rbind(
    ...
    loglinear_loglinear_n_1500_sigma_2_simultaneous_non_constraint_theta_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_2_simultaneous_non_constraint_theta_constraint
)
...
<!-- ```{r,echo=FALSE,results = "asis"} -->
<!-- loglinear_loglinear_sigma_0.001_mpec_separate_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_0.001_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_0.001_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_0.001_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_0.001_mpec_separate_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_0.001_mpec_separate_non_constraint_theta_constraint -->
<!-- ) -->
<!-- loglinear_loglinear_sigma_0.5_mpec_separate_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_0.5_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_0.5_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_0.5_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_0.5_mpec_separate_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_0.5_mpec_separate_non_constraint_theta_constraint -->
<!-- ) -->

<!-- loglinear_loglinear_sigma_1_mpec_separate_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_1_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_1_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_1_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_1_mpec_separate_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_1_mpec_separate_non_constraint_theta_constraint -->
<!-- ) -->

<!-- loglinear_loglinear_sigma_2_mpec_separate_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_2_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_2_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_2_mpec_separate_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_2_mpec_separate_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_2_mpec_separate_non_constraint_theta_constraint -->
<!-- ) -->
...
<!-- ```{r,echo=FALSE,results = "asis"} -->
<!-- loglinear_loglinear_sigma_0.001_optim_nelder_mead_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_0.001_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_0.001_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_0.001_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_0.001_optim_nelder_mead_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_0.001_optim_nelder_mead_non_constraint_theta_constraint -->
<!-- ) -->
<!-- loglinear_loglinear_sigma_0.5_optim_nelder_mead_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_0.5_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_0.5_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_0.5_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_0.5_optim_nelder_mead_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_0.5_optim_nelder_mead_non_constraint_theta_constraint -->
<!-- ) -->

<!-- loglinear_loglinear_sigma_1_optim_nelder_mead_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_1_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_1_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_1_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_1_optim_nelder_mead_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_1_optim_nelder_mead_non_constraint_theta_constraint -->
<!-- ) -->

<!-- loglinear_loglinear_sigma_2_optim_nelder_mead_non_constraint_theta_constraint <- -->
<!--   rbind( -->
<!--     loglinear_loglinear_n_50_sigma_2_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_100_sigma_2_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_200_sigma_2_optim_nelder_mead_non_constraint_theta_constraint, -->
<!--     loglinear_loglinear_n_1000_sigma_2_optim_nelder_mead_non_constraint_theta_constraint) -->
<!-- create_table_loglinear_with_demand_shifter_bias_rmse( -->
<!--   loglinear_loglinear_sigma_2_optim_nelder_mead_non_constraint_theta_constraint -->
<!-- ) -->
