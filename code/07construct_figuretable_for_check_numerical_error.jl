...
for t = [50, 100, 200, 1000], sigma = [0.001, 0.5, 1, 2]
    ...
    histo_result = Plots.histogram(xlims = [0, 1], title = "true start, tight, n = $t, σ = $sigma", legend = :topright, size = (800, 600))
    ...
    for estimation_method = estimation_methods
        ...
        histo_status = Plots.plot(Plots.histogram(estimation_result.status), xlims = [1,24], bins = 1:1:24, title = "true start, tight, n = $t, σ = $sigma")
...
for t = [50, 100, 200, 1000], sigma = [0.001, 0.5, 1, 2]
    ...
    histo_result = Plots.histogram(xlims = [-10^5, 10^3], title = "random start, tight, n = $t, σ = $sigma", legend = :topright, size = (800, 600))
    Plots.vline!(histo_result, [θ], label = "true value : θ = $θ")
    ...
    for estimation_method = estimation_methods
        ...
        histo_status = Plots.plot(histogram(estimation_result.status), xlims = [1,24], bins = 1:1:24, title = "random start, tight, n = $t, σ = $sigma")
        ...
        Plots.histogram!(histo_result, estimation_result, xlims = [-10^5, 10^3], xlabel = "θ",ylabel = "counts", label = label_title, fill = true, fillalpha = 0.5, bins = -10^5:1000:10^3)
