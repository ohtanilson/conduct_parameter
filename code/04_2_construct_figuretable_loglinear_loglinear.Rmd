...
## 250502 non_constraint_slope_constraint
sigma_list <-
  c(
    #0.001,
    0.5, 
...
constraint_list <-
  c(
    #"_separate_non_constraint_slope_constraint",
    "_simultaneous_no_constraint_slope_constraint"
    )
for(nn in 1:length(n_observation_list)){
  for(ss in 1:length(sigma_list)){
    for(cc in 1:length(constraint_list)){
      ...
      temp_data <-
        readr::read_csv(
          file =
            here::here(
              paste(
                "output/loglinear_simulation_result/",
                "parameter_hat_table_",
                filename,
                ".csv",
                sep = ""
...
for(nn in 1:length(n_observation_list)){
  for(ss in 1:length(sigma_list)){
    for(cc in 1:length(constraint_list)){
      ...
      if(temp_constraint == "_simultaneous_theta_constraint_slope_constraint"){
        # read gmm objective value at true values
        temp_data_obj_value_at_true_values <-
          readr::read_csv(
            file =
              here::here(
                paste(
        ...
        # drop id
        temp_data_obj_value_at_true_values <-
          temp_data_obj_value_at_true_values[,2]
        colnames(temp_data_obj_value_at_true_values)[1] <-
          "gmm_objective_value_at_true_values"
        temp_data <-
          cbind(
            temp_data,
            temp_data_obj_value_at_true_values
...
create_table_loglinear_with_demand_shifter_bias_rmse <-
  function(target_data,
    ...
    for(nn in 1:length(file_name_list)){
      ...
      if(non_constraint_indicator == TRUE){
        temp_bias_rmse <-
          data.frame(
            "Bias" = 
              c(
...
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_0.001_separate_theta_constraint_non_constraint,
  non_constraint_indicator = FALSE
)
...
#### compare gmm non_constraint_non_constraint with theta_constraint_slope_constraint

```{r,echo=FALSE,results = "asis"}
# note gmm obj is  - Q(theta) for minimization
loglinear_loglinear_sigma_0.5_simultaneous_non_constraint_non_constraint$lower_obj_than_non_constraint <-
  loglinear_loglinear_sigma_0.5_simultaneous_non_constraint_non_constraint[,13] <
  loglinear_loglinear_sigma_0.5_simultaneous_theta_constraint_slope_constraint[,13]
cat("sigma_0.5")
loglinear_loglinear_sigma_0.5_simultaneous_non_constraint_non_constraint %>% 
  dplyr::group_by(filename) %>% 
  dplyr::summarise(
    const_has_lower_obj_than_non_constraint = 
      sum(lower_obj_than_non_constraint, na.rm = TRUE)/1000
  )
loglinear_loglinear_sigma_1_simultaneous_non_constraint_non_constraint$lower_obj_than_non_constraint <-
  loglinear_loglinear_sigma_1_simultaneous_non_constraint_non_constraint[,13] <
  loglinear_loglinear_sigma_1_simultaneous_theta_constraint_slope_constraint[,13]
cat("sigma_1")
loglinear_loglinear_sigma_1_simultaneous_non_constraint_non_constraint %>% 
  dplyr::group_by(filename) %>% 
  dplyr::summarise(
...
loglinear_loglinear_sigma_2_simultaneous_non_constraint_non_constraint$lower_obj_than_non_constraint <-
  loglinear_loglinear_sigma_2_simultaneous_non_constraint_non_constraint[,13] <
  loglinear_loglinear_sigma_2_simultaneous_theta_constraint_slope_constraint[,13]
cat("sigma_2")
loglinear_loglinear_sigma_2_simultaneous_non_constraint_non_constraint %>% 
  dplyr::group_by(filename) %>% 
  dplyr::summarise(
...
### non_constraint_slope_constraint {.tabset}

#### simultaneous

```{r,echo=FALSE,results = "asis"}
# loglinear_loglinear_sigma_0.001_simultaneous_no_constraint_slope_constraint <-
#   rbind(
#     #loglinear_loglinear_n_50_sigma_0.001_simultaneous_no_constraint_slope_constraint,
#     loglinear_loglinear_n_100_sigma_0.001_simultaneous_no_constraint_slope_constraint,
#     loglinear_loglinear_n_200_sigma_0.001_simultaneous_no_constraint_slope_constraint,
#     loglinear_loglinear_n_1000_sigma_0.001_simultaneous_no_constraint_slope_constraint,
#     loglinear_loglinear_n_1500_sigma_0.001_simultaneous_no_constraint_slope_constraint)
# create_table_loglinear_with_demand_shifter_bias_rmse(
#   loglinear_loglinear_sigma_0.001_simultaneous_no_constraint_slope_constraint,
#   non_constraint_indicator = FALSE
# )
loglinear_loglinear_sigma_0.5_simultaneous_no_constraint_slope_constraint <-
  rbind(
    #loglinear_loglinear_n_50_sigma_0.5_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_100_sigma_0.5_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_200_sigma_0.5_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_1000_sigma_0.5_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_1500_sigma_0.5_simultaneous_no_constraint_slope_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_0.5_simultaneous_no_constraint_slope_constraint,
  non_constraint_indicator = FALSE
)

loglinear_loglinear_sigma_1_simultaneous_no_constraint_slope_constraint <-
  rbind(
    #loglinear_loglinear_n_50_sigma_1_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_100_sigma_1_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_200_sigma_1_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_1000_sigma_1_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_1500_sigma_1_simultaneous_no_constraint_slope_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_1_simultaneous_no_constraint_slope_constraint,
  non_constraint_indicator = FALSE
)

loglinear_loglinear_sigma_2_simultaneous_no_constraint_slope_constraint <-
  rbind(
    #loglinear_loglinear_n_50_sigma_2_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_100_sigma_2_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_200_sigma_2_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_1000_sigma_2_simultaneous_no_constraint_slope_constraint,
    loglinear_loglinear_n_1500_sigma_2_simultaneous_no_constraint_slope_constraint)
create_table_loglinear_with_demand_shifter_bias_rmse(
  loglinear_loglinear_sigma_2_simultaneous_no_constraint_slope_constraint,
  non_constraint_indicator = FALSE
)
...
#   output = "table.tex"
#   )
compute_rate_mpec_gmm_closer_to_true_gmm_among_both_converged_different_sol_n2sls_lower_obj <-
  function(
    target_simultaneous,
    target_mpec
    ){
  rate_mpec_gmm_closer_to_true_gmm <-
  #   sum(
  #   # mpec gmm is close to true gmm
  #   # distance simultaneous from true
  #   abs(target_simultaneous[
  #     res$classification == "Both converged, different sol, N2SLS has lower obj" |
  #       res$classification == "Both converged, different sol, MPEC has lower obj",13] -
  #   target_simultaneous[
  #     res$classification == "Both converged, different sol, N2SLS has lower obj" |
  #       res$classification == "Both converged, different sol, MPEC has lower obj",14]) >
  #   # distance simultaneous from true
  #   abs(target_mpec[
  #     res$classification == "Both converged, different sol, N2SLS has lower obj" |
  #       res$classification == "Both converged, different sol, MPEC has lower obj",13] -
  ...
  sum(
    ...
    # distance simultaneous from true
    abs(target_simultaneous[
      res$classification == "Both converged, different sol, N2SLS has lower obj",13] -
    target_simultaneous[
      res$classification == "Both converged, different sol, N2SLS has lower obj",14]) >
    # distance simultaneous from true
    abs(target_mpec[
      res$classification == "Both converged, different sol, N2SLS has lower obj",13] -
    target_simultaneous[
      ...
      res$classification == "Both converged, different sol, N2SLS has lower obj",13])
  return(rate_mpec_gmm_closer_to_true_gmm)
}
...
cat("rate_mpec_gmm_closer_to_true_gmm_among_both_converged_different_sol_n2sls_lower_obj", rate_mpec_gmm_closer_to_true_gmm)
```
