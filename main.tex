...
\begin{table}[!htbp]
  \begin{center}
      ...
      \subfloat[$\sigma=0.001$]{\input{R/figuretable/linear_linear_sigma_0.001}}\\
      \subfloat[$\sigma=0.5$]{\input{R/figuretable/linear_linear_sigma_0.5}}
...
\begin{table}[!htbp]
  \begin{center}
      ...
      \subfloat[$\sigma=1.0$]{\input{R/figuretable/linear_linear_sigma_1}}\\
      \subfloat[$\sigma=2.0$]{\input{R/figuretable/linear_linear_sigma_2}}
  \end{center}\footnotesize
  Note: True parameters: $\alpha_1 = \alpha_2 = \alpha_3 = \gamma_0 = \gamma_1 = \gamma_2  = \gamma_3 = 1, \alpha_0 = 10, \theta = 0.5.$
\end{table} 
...
\begin{table}[!htbp]
  \begin{center}
      ...
      \subfloat[$\sigma=0.001$]{\input{R/figuretable/linear_linear_sigma_0.001_without_demand_shifter_y}}\\
      \subfloat[$\sigma=0.5$]{\input{R/figuretable/linear_linear_sigma_0.5_without_demand_shifter_y}}
  \end{center}\footnotesize
...
\begin{table}[!htbp]
  \begin{center}
      ...
      \subfloat[$\sigma=1.0$]{\input{R/figuretable/linear_linear_sigma_1_without_demand_shifter_y}}\\
      \subfloat[$\sigma=2.0$]{\input{R/figuretable/linear_linear_sigma_2_without_demand_shifter_y}}
  \end{center}\footnotesize
  Note: True parameters: $\alpha_1 = \alpha_2 =  \gamma_0 = \gamma_1 = \gamma_2  = 1, \alpha_0 = 10, \theta = 0.5.$
\end{table} 
