...
Based on the result, we can find any marginal cost function that leads to observational equivalence under the inverse demand \eqref{eq:demand_counterexample}.
