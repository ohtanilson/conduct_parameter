...
\begin{table}[!htbp]
  \begin{center}
      ...
      \subfloat[$\sigma=0.001$]{\input{figuretable/counterexample_for_Lau1982_sigma_0.001_bias_rmse}}\\
      \subfloat[$\sigma=0.5$]{\input{figuretable/counterexample_for_Lau1982_sigma_0.5_bias_rmse}}\\
      \subfloat[$\sigma=1.0$]{\input{figuretable/counterexample_for_Lau1982_sigma_1_bias_rmse}}
  \end{center}
  \footnotesize
