...
\author{Yuri Matsumura\thanks{Department of Economics, Rice University. Email: \href{mailto:}{yuri.matsumura23@gmail.com}} \and Suguru Otani \thanks{Market Design Center, Department of Economics, University of Tokyo. Email: \href{mailto:}{suguru.otani@e.u-tokyo.ac.jp}.
...
\begin{table}[!htbp]
  \centering
  \caption{N2SLS with Constraints \eqref{eq:slope_constraint} and \eqref{eq:equilibrium_existence} for the loglinear model}
  \label{tb:loglinear_loglinear_sigma_0.5_simultaneous_no_constraint_slope_constraint_bias_rmse} 
